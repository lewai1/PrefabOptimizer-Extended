...
import dev.ninesliced.prefaboptimizer.ui.SelectionOptimizerPage;
...
public final class SelectionOptimizerSubCommand extends AbstractPlayerCommand {
    ...
    protected void execute(
        ...
        if (selection == null || !selection.hasSelectionBounds()) {
            context.sendMessage(Message.raw("PrefabOptimizer: make a BuilderTools selection first, then run /prefaboptimizer selection."));
            return;
        }
