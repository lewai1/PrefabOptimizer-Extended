...
import dev.ninesliced.prefaboptimizer.optimization.PrefabOptimizationResult;
import dev.ninesliced.prefaboptimizer.optimization.PrefabOptimizerService;
import dev.ninesliced.prefaboptimizer.util.ThrowableMessages;
...
public final class PrefabOptimizerPage extends InteractiveCustomUIPage<OptimizerEventData> {
    ...
    private boolean optimizeSelectedPrefabs(@Nonnull OptimizerEventData data) {
        ...
        this.playerRef.sendMessage(Message.raw("PrefabOptimizer: " + this.status));
    ...
    private void handleBatchFinished(
        ...
        for (String warning : result.warnings()) {
            this.playerRef.sendMessage(Message.raw("PrefabOptimizer warning: " + warning));
        }
    }
